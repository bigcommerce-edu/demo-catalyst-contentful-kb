...
import { KbArticleAbstract } from '~/components/custom/knowledgebase/article-abstract';
import { Combobox } from '@makeswift/runtime/controls';
import { z } from 'zod';
import useSWR from 'swr';
import { FetchKbArticleAbstractResponse } from '~/app/api/kb/[locale]/article/[id]/route';
...
runtime.registerComponent(
  ({
    ...
    const { data } = useSWR<FetchKbArticleAbstractResponse>(
    ...
    return (
      <KbArticleAbstract article={article} />
    );
  },
  {
    type: 'kb-article',
